...
const PERMISSION_NAMES: { value: PermissionName; label: string }[] = [
  { value: 'view_athletes', label: 'Vizualizare Atleți' },
  { value: 'edit_athletes', label: 'Editare Atleți' },
  { value: 'delete_athletes', label: 'Ștergere Atleți' },
  { value: 'view_results', label: 'Vizualizare Rezultate' },
  { value: 'edit_results', label: 'Editare Rezultate' },
  { value: 'delete_results', label: 'Ștergere Rezultate' },
  { value: 'view_events', label: 'Vizualizare Probe' },
  { value: 'edit_events', label: 'Editare Probe' },
  { value: 'delete_events', label: 'Ștergere Probe' },
  { value: 'manage_coaches', label: 'Gestionare Antrenori' },
  { value: 'manage_users', label: 'Gestionare Utilizatori' },
  { value: 'manage_permissions', label: 'Gestionare Permisiuni' },
  { value: 'approve_accounts', label: 'Aprobare Conturi' },
  { value: 'view_messages', label: 'Vizualizare Mesaje' },
  { value: 'send_messages', label: 'Trimitere Mesaje' }
]
