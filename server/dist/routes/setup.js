 ...
 */
const seedComponentWidgets = async (_req, res) => {
    const client = await database_1.default.connect();
    try {
        ...
        for (const component of componentsData) {
            const result = await client.query(`INSERT INTO components (name, display_name, description, component_type, icon, order_index, is_system)
         VALUES ($1, $2, $3, $4, $5, $6, true)
         ON CONFLICT (name) DO NOTHING`, component);
...
exports.seedComponentWidgets = seedComponentWidgets;
/**
