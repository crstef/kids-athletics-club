...
const addGranularPermissions = async (req, res) => {
    ...
    `);
        ...
        for (const comp of components) {
            await client.query(`INSERT INTO components (name, display_name, description, component_type, is_system, icon, order_index)
         VALUES ($1, $2, $3, $4, true, $5, $6)
         ON CONFLICT DO NOTHING`, [comp.name, comp.display_name, `${comp.display_name} component`, comp.type, comp.icon, comp.order]);
        }
        ...
        for (const role of rolesResult.rows) {
            ...
            for (const comp of compsResult.rows) {
                ...
                await client.query(`INSERT INTO component_permissions (role_id, component_id, can_view, can_create, can_edit, can_delete)
           VALUES ($1, $2, $3, $4, $5, $6)
           ON CONFLICT (role_id, component_id) DO NOTHING`, [role.id, comp.id, perm.view, perm.create, perm.edit, perm.delete]);
                permCount++;
            }
        }
...
exports.addGranularPermissions = addGranularPermissions;
