...
const approveRequest = async (req, res) => {
    ...
    try {
        ...
        const requestResult = await client.query('SELECT * FROM approval_requests WHERE id = $1 FOR UPDATE', [requestId]);
        ...
        switch (request.requested_role) {
            case 'parent': {
             ...
             WHERE parent_id = $1 AND athlete_id = $2 AND coach_id = $3`, [request.user_id, request.athlete_id, request.coach_id]);
               ...
               VALUES ($1, $2, $3, 'approved', CURRENT_TIMESTAMP, $4)`, [request.user_id, request.athlete_id, request.coach_id, request.approval_notes || null]);
                    }
                }
                break;
            }
